...
function Hero() {
  ...
  return (
    <section
      id="home"
      className={`min-h-[85dvh] md:min-h-screen flex items-start justify-center text-center px-4 sm:px-6 pt-20 sm:pt-24 md:pt-36 pb-16 md:pb-0 relative isolate overflow-hidden transition-all duration-1000 ${
