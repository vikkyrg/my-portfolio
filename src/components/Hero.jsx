...
function Hero() {
  ...
  return (
    <section
      id="home"
      className={`min-h-screen flex items-center justify-center text-center px-4 sm:px-6 pt-20 sm:pt-24 md:pt-36 relative overflow-visible transition-all duration-1000 ${
